...
# Logistic metrics
table2[3,] <- c("Logistic", round(logit.accuracy, digits = 2), round(logit.precision, digits = 2), round(logit.recall, digits = 2), round(logit.spec, digits = 2))


# Lasso metrics
table2[4,] <- c("Lasso", round(lasso.accuracy, digits = 2), round(lasso.precision, digits = 2), round(lasso.recall, digits = 2), round(lasso.spec, digits = 2))


# Boosting metrics
table2[5,] <- c("Boosting", round(lasso.accuracy, digits = 2), round(lasso.precision, digits = 2), round(lasso.recall, digits = 2), round(lasso.spec, digits = 2))
